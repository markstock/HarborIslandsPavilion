...
int baseWidth = 64;
int baseHeight = 48;
// Set multiplier to 1 for production, larger for testing
int testMult = 1;
int width = testMult*baseWidth;
int height = testMult*baseHeight;
